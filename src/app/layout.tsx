...
const globalStructuredData = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "SiteNavigationElement", position: 2, name: "Knowledge Centre", url: `${siteUrl}/knowledge-centre` },
      { "@type": "SiteNavigationElement", position: 3, name: "Methodology", url: `${siteUrl}/methodology` },
      { "@type": "SiteNavigationElement", position: 4, name: "Affiliate Disclosure", url: `${siteUrl}/affiliate-disclosure` },
      { "@type": "SiteNavigationElement", position: 5, name: "Privacy Policy", url: `${siteUrl}/privacy-policy` },
    ],
  },
];
